...
if __name__=='__main__':
    ...
    epsilon[:,-CPML:]=epsilon[:,-CPML-1].reshape((len(epsilon[:,-CPML-1]),-1))
    pyplot.figure()
    gci=pyplot.imshow(epsilon[35:85,135:185],extent=(0,1,1,0),cmap=cm.jet,vmin=3,vmax=8)
    ax=pyplot.gca()
    ...
    cbar=pyplot.colorbar(gci,cax=cax)
    cbar.set_label('$\epsilon_r$')
    pyplot.savefig('Add_06_TrueModelPart.png',dpi=1000)
    ...
    cbar=pyplot.colorbar(gci,cax=cax)
    cbar.set_label('$\epsilon_r$')
    pyplot.savefig('Add_07_FWIModelPart.png',dpi=1000)
    
    pyplot.figure()
    gci=pyplot.imshow(iepsilon[35:85,135:185],extent=(0,1,1,0),cmap=cm.jet,vmin=3,vmax=8)
    ax=pyplot.gca()
    ax.set_xticks(np.linspace(0,1,5))
    ax.set_xticklabels([2.5,2.75,3,3.25,3.5])
    ax.set_yticks(np.linspace(0,1,5))
    ...
    cbar=pyplot.colorbar(gci,cax=cax)
    cbar.set_label('$\epsilon_r$')
    pyplot.savefig('Add_08_InitModelPart.png',dpi=1000)
